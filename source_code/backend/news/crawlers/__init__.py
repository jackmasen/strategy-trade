...
from .cn_media import CLSCrawler, BishijieCrawler, WallStreetCNCrawler, DecryptCrawler, DailyFXCrawler, Jin10Crawler, BinanceAnnouncementCrawler
...
ALL_CRAWLERS = [
    ...
    Jin10Crawler, BinanceAnnouncementCrawler,
]
