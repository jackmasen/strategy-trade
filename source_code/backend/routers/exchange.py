...
_MOCK_PRICES = {
    ...
    "BNB": 500, "XRP": 0.5, "ADA": 0.4, "DOGE": 0.12, "AVAX": 30, "LINK": 15,
    "XAU": 2500, "XAG": 30, "WTI": 75,
    "TSLA": 250, "NVDA": 120, "AAPL": 220, "MSFT": 420, "TCEHY": 60,
    "SKHYNIX": 1219.75, "SNDK": 1555.05,
    "GOOGL": 165, "AMZN": 185, "META": 500, "NFLX": 650,
    "KO": 62, "PG": 168, "WMT": 82, "JNJ": 160, "PEP": 175,
    "INTC": 30, "MCD": 295, "JPM": 210, "AMD": 145, "MSTR": 1300,
...
SUPPORTED_SYMBOLS = [
    {"symbol": "BTC", "name": "比特币", "binance": "BTCUSDT", "okx": "BTC-USDT-SWAP", "bybit": "BTCUSDT", "gate": "BTC_USDT", "type": "crypto"},
    {"symbol": "ETH", "name": "以太坊", "binance": "ETHUSDT", "okx": "ETH-USDT-SWAP", "bybit": "ETHUSDT", "gate": "ETH_USDT", "type": "crypto"},
    {"symbol": "SOL", "name": "索拉纳", "binance": "SOLUSDT", "okx": "SOL-USDT-SWAP", "bybit": "SOLUSDT", "gate": "SOL_USDT", "type": "crypto"},
    {"symbol": "BNB", "name": "币安币", "binance": "BNBUSDT", "okx": "BNB-USDT-SWAP", "bybit": "BNBUSDT", "gate": "BNB_USDT", "type": "crypto"},
    {"symbol": "XRP", "name": "瑞波币", "binance": "XRPUSDT", "okx": "XRP-USDT-SWAP", "bybit": "XRPUSDT", "gate": "XRP_USDT", "type": "crypto"},
    {"symbol": "ADA", "name": "艾达币", "binance": "ADAUSDT", "okx": "ADA-USDT-SWAP", "bybit": "ADAUSDT", "gate": "ADA_USDT", "type": "crypto"},
    {"symbol": "DOGE", "name": "狗狗币", "binance": "DOGEUSDT", "okx": "DOGE-USDT-SWAP", "bybit": "DOGEUSDT", "gate": "DOGE_USDT", "type": "crypto"},
    {"symbol": "AVAX", "name": "雪崩币", "binance": "AVAXUSDT", "okx": "AVAX-USDT-SWAP", "bybit": "AVAXUSDT", "gate": "AVAX_USDT", "type": "crypto"},
    {"symbol": "LINK", "name": "Chainlink", "binance": "LINKUSDT", "okx": "LINK-USDT-SWAP", "bybit": "LINKUSDT", "gate": "LINK_USDT", "type": "crypto"},
    {"symbol": "XAU", "name": "黄金", "binance": "", "okx": "XAU-USDT-SWAP", "bybit": "XAUUSDT", "gate": "XAU_USDT", "type": "commodity"},
    {"symbol": "XAG", "name": "白银", "binance": "", "okx": "XAG-USDT-SWAP", "bybit": "XAGUSDT", "gate": "XAG_USDT", "type": "commodity"},
    {"symbol": "WTI", "name": "石油", "binance": "", "okx": "WTI-USDT-SWAP", "bybit": "CLUSDT", "gate": "WTI_USDT", "type": "commodity"},
    {"symbol": "TSLA", "name": "特斯拉", "binance": "", "okx": "TSLA-USDT-SWAP", "bybit": "TSLAUSDT", "gate": "TSLA_USDT", "type": "stock"},
    {"symbol": "NVDA", "name": "英伟达", "binance": "", "okx": "NVDA-USDT-SWAP", "bybit": "NVDAUSDT", "gate": "NVDA_USDT", "type": "stock"},
    {"symbol": "AAPL", "name": "苹果", "binance": "", "okx": "AAPL-USDT-SWAP", "bybit": "AAPLUSDT", "gate": "AAPL_USDT", "type": "stock"},
    {"symbol": "MSFT", "name": "微软", "binance": "", "okx": "MSFT-USDT-SWAP", "bybit": "MSFTUSDT", "gate": "MSFT_USDT", "type": "stock"},
    {"symbol": "TCEHY", "name": "腾讯", "binance": "", "okx": "TCEHY-USDT-SWAP", "bybit": "TCEHYUSDT", "gate": "TCEHY_USDT", "type": "stock"},
    {"symbol": "SKHYNIX", "name": "SK海力士", "binance": "", "okx": "SKHYNIX-USDT-SWAP", "bybit": "SKHYNIXUSDT", "gate": "SKHYNIX_USDT", "type": "stock"},
    {"symbol": "SNDK", "name": "闪迪", "binance": "", "okx": "SNDK-USDT-SWAP", "bybit": "SNDKUSDT", "gate": "SNDK_USDT", "type": "stock"},
    {"symbol": "GOOGL", "name": "谷歌", "binance": "", "okx": "GOOGL-USDT-SWAP", "bybit": "GOOGLUSDT", "gate": "GOOGL_USDT", "type": "stock"},
    {"symbol": "AMZN", "name": "亚马逊", "binance": "", "okx": "AMZN-USDT-SWAP", "bybit": "AMZNUSDT", "gate": "AMZN_USDT", "type": "stock"},
    {"symbol": "META", "name": "元宇宙", "binance": "", "okx": "META-USDT-SWAP", "bybit": "METAUSDT", "gate": "META_USDT", "type": "stock"},
    {"symbol": "NFLX", "name": "奈飞", "binance": "", "okx": "NFLX-USDT-SWAP", "bybit": "NFLXUSDT", "gate": "NFLX_USDT", "type": "stock"},
    {"symbol": "KO", "name": "可口可乐", "binance": "", "okx": "KO-USDT-SWAP", "bybit": "KOUSDT", "gate": "KO_USDT", "type": "stock"},
    {"symbol": "PG", "name": "宝洁", "binance": "", "okx": "PG-USDT-SWAP", "bybit": "PGUSDT", "gate": "PG_USDT", "type": "stock"},
    {"symbol": "WMT", "name": "沃尔玛", "binance": "", "okx": "WMT-USDT-SWAP", "bybit": "WMTUSDT", "gate": "WMT_USDT", "type": "stock"},
    {"symbol": "JNJ", "name": "强生", "binance": "", "okx": "JNJ-USDT-SWAP", "bybit": "JNJUSDT", "gate": "JNJ_USDT", "type": "stock"},
    {"symbol": "PEP", "name": "百事", "binance": "", "okx": "PEP-USDT-SWAP", "bybit": "PEPUSDT", "gate": "PEP_USDT", "type": "stock"},
    {"symbol": "INTC", "name": "英特尔", "binance": "", "okx": "INTC-USDT-SWAP", "bybit": "INTCUSDT", "gate": "INTC_USDT", "type": "stock"},
    {"symbol": "MCD", "name": "麦当劳", "binance": "", "okx": "MCD-USDT-SWAP", "bybit": "MCDUSDT", "gate": "MCD_USDT", "type": "stock"},
    {"symbol": "JPM", "name": "摩根大通", "binance": "", "okx": "JPM-USDT-SWAP", "bybit": "JPMUSDT", "gate": "JPM_USDT", "type": "stock"},
    {"symbol": "AMD", "name": "AMD", "binance": "", "okx": "AMD-USDT-SWAP", "bybit": "AMDUSDT", "gate": "AMD_USDT", "type": "stock"},
    {"symbol": "MSTR", "name": "MicroStrategy", "binance": "", "okx": "MSTR-USDT-SWAP", "bybit": "MSTRUSDT", "gate": "MSTR_USDT", "type": "stock"},
    {"symbol": "COIN", "name": "Coinbase", "binance": "", "okx": "COIN-USDT-SWAP", "bybit": "COINUSDT", "gate": "COIN_USDT", "type": "stock"},
    {"symbol": "PLTR", "name": "Palantir", "binance": "", "okx": "PLTR-USDT-SWAP", "bybit": "PLTRUSDT", "gate": "PLTR_USDT", "type": "stock"},
    {"symbol": "SMCI", "name": "超微电脑", "binance": "", "okx": "SMCI-USDT-SWAP", "bybit": "SMCIUSDT", "gate": "SMCI_USDT", "type": "stock"},
]
...
class CreateAccountReq(BaseModel):
    exchange: int = Field(..., ge=1, le=4, description="1-币安 2-OKX 3-Bybit 4-Gate")
...
def _try_get_demo_client(db) -> 'ExchangeClientBase | None':
    ...
    try:
        ...
        if not api_key or not api_secret:
            return None
        exchange_id = {"binance": 1, "okx": 2, "bybit": 3, "gate": 4}.get(exchange_str, 2)
        client = ExchangeClientBase.create(
